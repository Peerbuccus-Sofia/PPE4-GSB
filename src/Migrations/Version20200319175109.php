 ...
 */
final class Version20200319175109 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE admin CHANGE ROLE ROLE JSON DEFAULT \'ROLE_ADMIN\', CHANGE PASSWORD PASSWORD VARCHAR(255) NOT NULL');
        $this->addSql('ALTER TABLE appartement ADD updated_at DATETIME NOT NULL, CHANGE CP CP INTEGER DEFAULT NULL, CHANGE FILENAME filename VARCHAR(255) NULL');
        ...
        $this->addSql('ALTER TABLE proprietaire DROP ROLE, CHANGE PASSWORD PASSWORD VARCHAR(255) ');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE appartement DROP updated_at, CHANGE CP CP INT DEFAULT NULL, CHANGE filename FILENAME VARCHAR(255) CHARACTER SET latin1 DEFAULT \'NULL\' COLLATE `latin1_swedish_ci`');
